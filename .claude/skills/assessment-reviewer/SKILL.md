...
- `excluded`: do not contribute to learner-model updates.
...
4. Submit a revised review draft item that clears `needs_ai_re_review`.

Finalization should not proceed while any non-excluded item has `needs_ai_re_review: true`.
